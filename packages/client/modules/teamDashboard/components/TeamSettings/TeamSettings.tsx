...
const TeamSettings = (props: Props) => {
  ...
  const { isLead: viewerIsLead, isOrgAdmin: viewerIsOrgAdmin } =
    viewerTeamMember;
      ...
      <PanelsLayout>
        {viewerIsLead || viewerIsOrgAdmin ? (
          ...
          <Panel className="mt-8">
            <StyledRow>
              <div>
                This team is currently on a{" "}
                <b className="capitalize">{billingTier} plan</b>. Only Team
                Leads can <b>delete a team</b>.<br />
